...
const Footer = () => {
  return (
    <div className='page-container z-0 relative'>
      ...
      {/* img */}
      <div className="h-60 md:h-80 lg:h-96 w-full flex items-center justify-center relative overflow-hidden">
        <Image
      ...
      <div className="overflow-hidden h-fit md:h-[450px] mb-5 text-white flex flex-col items-start w-full p-5">
      ...
      <div className="text-white flex flex-col items-start w-full">
        <FadeIn>
          <h1 className="text-base font-formulaWide md:my-2 p-5 lg:text-xl">Our Sponsors</h1>
        </FadeIn>
